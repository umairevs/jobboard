            ...
            <tr>
              ...
              <td colspan="3" align="center" width="100%"><table cellpadding="0" cellspacing="2" border="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td width="78%" align="left" ><input type="text" class="txtstyle" name="emp_title" id="emp_title"  value="<?php echo utf8_decode(stripslashes($recipe['emp_title']));?>"  /></font>
                  ...
                  <tr>
                    ...
                    <td colspan="3" align="left" style="padding-left:190px; padding-top:20px;"><?php if(isset($recipe['emp_id'])) {?>

                      <input type="submit" value="Update"  class="txtbutton" id="bank_button" name="bank_button" onclick="return manage_bank('7');">

                      <input type="hidden" name="emp_id" value="<?php echo $recipe['emp_id']?>"   />
