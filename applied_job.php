			...
			<div class="section trending-ads latest-jobs-ads">
					...
					<div class="item-info">
						<div class="item-image-box">
							<div class="item-image">
								<a href="job-details.html"><img src="<?php echo SERVER_ROOTPATH;?>images/job/4.png" alt="Image" class="img-responsive"></a>
							</div><!-- item-image -->
						</div>
				...
				<div class="job-ad-item">
					<div class="item-info">
						<div class="item-image-box">
							<div class="item-image">
								<a href="job-details.html"><img src="<?php echo SERVER_ROOTPATH;?>images/job/2.png" alt="Image" class="img-responsive"></a>
							</div><!-- item-image -->
						</div>
				...
				<div class="job-ad-item">
					<div class="item-info">
						<div class="item-image-box">
							<div class="item-image">
								<a href="job-details.html"><img src="<?php echo SERVER_ROOTPATH;?>images/job/3.png" alt="Image" class="img-responsive"></a>
							</div><!-- item-image -->
						</div>
				...
				<div class="job-ad-item">
					<div class="item-info">
						<div class="item-image-box">
							<div class="item-image">
								<a href="job-details.html"><img src="<?php echo SERVER_ROOTPATH;?>images/job/1.png" alt="Image" class="img-responsive"></a>
							</div><!-- item-image -->
						</div>
