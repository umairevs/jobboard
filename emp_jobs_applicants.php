		...
		<div class="container">
			<div class="breadcrumb-section">
				<ol class="breadcrumb">
                    ...
                    <li>Jobs Applicants</li>
                  
				</ol>						
				<h2 class="title">Jobs Applicants</h2>
            ...
            <div class="section trending-ads latest-jobs-ads">
				...
				<?php
					...
					else
					{
					 ...
					 $jobs_query		=	"Select a.seeker_id as resume_user_id, e.company_name, e.image, j.* from tbl_employer e, tbl_jobs j, tbl_jobs_applied a where j.employer_id = e.id AND j.job_status = 1 AND e.status = 1 AND a.job_id = j.id ANd e.id = a.emp_id AND a.emp_id = '".$_SESSION['employer']['id']."' order by a.id desc  LIMIT $start, $limit";	
