	...
	<section class="clearfix job-bg  ad-profile-page">
		<div class="container">
			<div class="breadcrumb-section">
				...
				<h2 class="title">Bookmarks List of Jobs</h2>
            ...
            <div class="section trending-ads latest-jobs-ads">
				...
				<?php
                	$list_jobs  =  jobs_list_bookmark_jobs();
					
					$targetpage = SERVER_ROOTPATH."jobseeker-bookmark"; 	//your file name  (the name of this file)	
					...
					else
					{
					 ...
					 $jobs_query		=	"Select e.company_name, e.image, j.* from tbl_employer e, tbl_jobs j, tbl_jobs_bookmark a where j.employer_id = e.id AND j.job_status = 1 AND e.status = 1 AND a.job_id = j.id ANd e.id = a.emp_id AND a.seeker_id = '".$_SESSION['jobseeker']['id']."' order by a.id desc  LIMIT $start, $limit";	
                        ...
                        <div class="job-ad-item">
                            <div class="item-info">
                                ...
                                <div class="close-icon">
                                   <a href="javascript:;" title="Remove Bookmark" style="margin-top:10px; float:right;" onClick="delete_bookmark(<?php echo $job_id;?>)"> <i class="fa fa-window-close" aria-hidden="true"></i></a>
                                </div>
