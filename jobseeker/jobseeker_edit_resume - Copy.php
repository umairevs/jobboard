								...
								<div class="section">
                                  ...
                                  <?php
												...
												?>
                                          		  <div class="input_fields_wrap">
                                                        ...
                                                        <div class="row form-group time-period">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="from_job[]" class="form-control" placeholder="dd/mm/yy"  value="<?php echo stripslashes($work_info['from_job']);?>"><span>-</span>
                                                                <input type="text" name="to_job[]" class="form-control pull-right" placeholder="dd/mm/yy"  value="<?php echo stripslashes($work_info['to_job']);?>">
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row form-group time-period">
                                            <label class="col-sm-3 label-title">Time Period</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="from_job[]" class="form-control" placeholder="dd/mm/yy"><span>-</span>
                                                <input type="text" name="to_job[]" class="form-control pull-right" placeholder="dd/mm/yy">
                                            </div>
                                        </div>
                                        <div class="row form-group job-description">
                                            <label class="col-sm-3 label-title">Job Description</label>
								...
								<div class="section education-background">
									...
									<div class="input_fields_wrap_edu">
									  ...
									  <div class="row form-group time-period">
										<label class="col-sm-3 label-title">Time Period</label>
										<div class="col-sm-9">
											<input type="text" name="from_date[]" class="form-control" placeholder="dd/mm/yy"><span>-</span>
											<input type="text" name="to_date[]" class="form-control pull-right" placeholder="dd/mm/yy">
										</div>
									</div>
									  <div class="row form-group job-description">
...
<div class="rating">
    ...
    <input type="radio" id="star4half_1" name="rating_1" value="4.5" /><label class="half" for="star4half_1" title="Pretty good - 4.5 stars"></label>
    <input type="radio" id="star4_1" name="rating_1" value="4" /><label class = "full" for="star4_1" title="Pretty good - 4 stars"></label>
    <input type="radio" id="star3half_1" name="rating_1" value="3.5" /><label class="half" for="star3half_1" title="Meh - 3.5 stars"></label>
    <input type="radio" id="star3_1" name="rating_1" value="3" /><label class = "full" for="star3_1" title="Meh - 3 stars"></label>
    <input type="radio" id="star2half_1" name="rating_1" value="2.5" /><label class="half" for="star2half_1" title="Kinda bad - 2.5 stars"></label>
    <input type="radio" id="star2_1" name="rating_1" value="2" /><label class = "full" for="star2_1" title="Kinda bad - 2 stars"></label>
    <input type="radio" id="star1half_1" name="rating_1" value="1.5" /><label class="half" for="star1half_1" title="Meh - 1.5 stars"></label>
    ...
    <input type="hidden" name = "rat_val[]" value="1">
								...
								<div class="section company-information">
									...
									<div class="row form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="dob" class="form-control" placeholder="26/01/1982" value="<?php echo $dob;?>">
										</div>
									</div>
									<div class="row form-group">
										<label class="col-sm-3 label-title">Birth Place</label>
										<div class="col-sm-9">
											<input type="text" name="birth_place" class="form-control" placeholder="United State of America" value="<?php echo $birth_place;?>">
										</div>
									</div>
									<div class="row form-group">
                            ...
                            <div class="buttons">
							<input type="submit" class="btn" style="color:#fff; background-color:#00A651;" onClick="return validate_add(11);" id="button1" value="Post Cv">
