        ...
        var A, B, C = function (O) {
            ...
            if (!B) {
                var Q = O.config.so || 'white',
                    R = ['<div style="position: ', e.ie6Compat ? 'absolute' : 'unset', '; z-index: ', O.config.baseFloatZIndex, '; top: 0px; left: 0px; ', !e.ie6Compat ? 'background-color: ' + Q : '', '" id="cke_dialog_background_cover">'];
                if (e.ie6Compat) {
