...
$mail->SetFrom('support@fgglobal.com', 'First Last');

$mail->AddReplyTo("support@fgglobal.com","First Last");
...
$address = "mmoeeziqbal@gmail.com";
$mail->AddAddress($address, "mmoeeziqbal");
