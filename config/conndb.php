<?php 
	...
	//------------------------------------------------------------------
				//  Data Base setting
	//------------------------------------------------------------------
	define("ACSQL_DB_USER", $mosConfig_user);						// <-- mysql db user
	define("ACSQL_DB_PASSWORD", $mosConfig_password);				// <-- mysql db password
	define("ACSQL_DB_NAME", $mosConfig_db);							// <-- mysql db name
	define("ACSQL_DB_HOST", $mosConfig_host);					// <-- mysql server host

	
	//---------------------------- for cookis and sessions------------------------------------------------
